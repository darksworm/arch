...
ROOT_PARTITION_END=$(expr $PARTITIONS_EFI_PARTITION_SIZE_MiB + $PARTITIONS_ROOT_PARTITION_SIZE_MiB)
HOME_PARTITION_END=$(expr $SECOND_PARTITION_END + $PARTITIONS_HOME_PARTITION_SIZE_MiB)
