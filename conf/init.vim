...
let g:vim_bootstrap_langs = "c,elixir,html,javascript,php,python,typescript"
...
set wildignore+=*/tmp/*,*.so,*.swp,*.zip,*.pyc,*.db,*.sqlite,package-lock.json,node_modules/*,node_modules,node_modules/*/*

""" custom bindings
nnoremap <silent> <F2> :Prettier<CR>
...
" The Silver Searcher
if executable('ag')
  let $FZF_DEFAULT_COMMAND = 'ag --hidden --ignore .git --ignore node_modules --ignore package-lock.json -g ""'
...
nnoremap <f5> :ArduinoUpload<CR>
nnoremap <f6> :ArduinoSerial<CR>
